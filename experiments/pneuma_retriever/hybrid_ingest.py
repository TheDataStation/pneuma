...
def start_indexing(
    ...
    client = chromadb.PersistentClient(
        f"indices/vector-index-{dataset}{f'-{schema_content_type}' if schema_content_type != "none" else ''}{f'-{row_content_type}' if row_content_type != "none" else ''}{'-context' if include_contexts else ''}"
    )
